...
"""
Utilities for creating delta separated useless_code sets.
"""
import numpy as np


def gen_k_centers(k, dim):
    """Create a k cluster useless_code set with required separation.
...
def create_dataset(dims, size, num_clusters=20):
    """Create a delta separated useless_code set.
    ...
    Args:
        dims - (int) the dimention of all useless_code points.
